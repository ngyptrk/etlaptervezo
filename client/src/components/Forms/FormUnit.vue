  ...
  <div>
    <Modal ref="modal" :title="title" @yesEvent="yesEventHandler">
      <div class="mb-4 row pt-2">
        <label for="unit" class="col-form-label col-auto pt-1 pe-0">
          Mértékegység:
        </label>
        <div class="col">
          <input
            ...
            required
          />
          <div v-if="!serverErrors.unit" class="invalid-feedback position-absolute">
            A mértékegység kötelező
          </div>
          <div
            v-if="serverErrors.unit"
...
export default {
  ...
  props: {
    title: { type: String, default: "Új mértékegység felvitele" },
