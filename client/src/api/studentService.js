...
export default {
   ...
   async getStudentsBySchoolclassId(schoolclassId,column='id', direction='asc', search='') {
    const route = `/studentsbyschoolclassid/${schoolclassId}/${column}/${direction}/${search}`
