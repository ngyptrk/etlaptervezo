...
class WeekdayController extends Controller
{
    ...
    {
         try {
            $row = Weekday::create($request->all());
     ...
     */
    public function update(UpdateWeekdayRequest $request, Weekday $weekday, int $id)
    {
         $row = $weekday::find($id);
        if ($row) {
            # code...
     ...
     */
    public function destroy(Weekday $weekday, int $id)
    {
        $row = Weekday::find($id);
        if (!$row) {
